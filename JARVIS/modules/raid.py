...
from JARVIS.data import RAID, REPLYRAID, FRIDAY, MRAID, SRAID, CRAID, FRIDAY
    ...
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in FRIDAY:
                ...
                await e.reply("YE BHI —͟͞͞★ LEGEND ★ KAA BACHA HAI ISPE RAID MAT MARO.. !!...")
            else:
    ...
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            if user_id in FRIDAY:
                ...
                await e.reply("=YE BHI —͟͞͞★ LEGEND ★ KA BACHA HAI ISPE RAID MAT MARO.. !!...")
            else:
                global REPLY_RAID
